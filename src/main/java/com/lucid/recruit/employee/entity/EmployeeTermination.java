...
public class EmployeeTermination extends EmployeeBased {
	...
	// Retirement, Voluntary (subcategory), Involuntary (subcategory), Transfer,
	// Business Sold. In EU
	// - info must be sent to government but the codes are provided by the
	// government. Will use
	// IdentifierType. This allows us to define who owns the list and the list
	// value.
	...
	// May need for statutory purposes. For example, we will pay you through end of
	// month but your
	// last worked day was on the 15th. Access turned off, etc from an HR
	// perspective.
	@Column(name = "last_worked_dt", nullable = true)
	private Date lastWorkedDate;

	// The date the worker was last paid. High level workers that have terminated
	// but the salary may
