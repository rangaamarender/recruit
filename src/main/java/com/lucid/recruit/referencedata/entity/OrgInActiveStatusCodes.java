...
@Entity
@Table(name = OrgInActiveStatusCodes.TABLE_NAME)
public class OrgInActiveStatusCodes{
	private static final long serialVersionUID = -2988048290068432549L;

	public static final String TABLE_NAME = "ref_org_inactive_status_codes";
